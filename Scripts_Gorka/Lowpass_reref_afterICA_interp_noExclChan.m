...
for N = [N]; 
    if N < 10
    [FILENAME] =['s',num2str(G),'0',num2str(N),'-vwr-ICA-pruned-br-interp-lp'];
    elseif N >=10 && N<100   
    [FILENAME] =['s',num2str(G),num2str(N),'-vwr-ICA-pruned-br-interp-lp'];
    end
...
% RE-REFERENCE to AVERAGE of the 64 electrodes
  FILENAME2 = [FILENAME '-refAvg-noExcInterp'];
