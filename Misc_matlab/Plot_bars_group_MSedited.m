...
%% Pop up for Input of subjects and values to plot
   prompt={'Define ERP component',...
       ...
       'Select channels','subjects group1','subjects group2'};
   name='Define subjects and output values to plot';
   numlines=1;
   defaultanswer = {'N1','dif','TP7,PO7,PO3,P9,P7,P5,O1,O2,P6,P8,P10,PO4,PO8,TP8','1,3:11,13:19,21','401,403:411,413:419,421'};
   options.Resize='on';
