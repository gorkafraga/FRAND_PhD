...
% IMPORT BDF AND FIRST PREPROCESING STEPS
% ===============================================================================
...
if  ( G== 0 && (N == 9 || N==  19)) || (G==1 && ( N == 7 || N == 17));
   run Z:\fraga\Scripts_Gorka_2013\rename_events_in_vwr_for_even_subjects.m
elseif isodd == 0; 
   run Z:\fraga\Scripts_Matlab_2013\rename_events_in_vwr_for_even_subjects.m
elseif  isodd~=0;
   run Z:\fraga\Scripts_Matlab_2013\rename_events_in_vwr_for_odd_subjects.m
