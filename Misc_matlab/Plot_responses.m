...
X21 = respvalues(2:end,3);
X21(X21==0) = []; 
Y21 = 1:length(X21);
X22 = respvalues(2:end,6);
X22(X22==0) = []; 
Y22 = 1:length(X22);
X23 = respvalues(2:end,9);
X23(X23==0) = []; 
Y23 = 1:length(X23);
X24 = respvalues(2:end,12);
X24(X24==0) = []; 
Y24 = 1:length(X24);
...
set(gca,'Title',text('String',FILENAME1,'Color','k'),'Position',[0.13 0.11 0.775 0.815]);
