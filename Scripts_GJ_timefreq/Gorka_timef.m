...
filepath = 'Y:\fraga\EEG_Gorka\Time_frequency\Gert-Jan';
cd 'Y:\fraga\EEG_Gorka\Time_frequency\Gert-Jan'
...
EEG = pop_loadset('filename','CONTROL_words.set','filepath','Y:\fraga\EEG_Gorka\Time_frequency\Gert-Jan');
[ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );
EEG = pop_loadset('filename','LEXY_words.set','filepath','Y:\fraga\EEG_Gorka\Time_frequency\Gert-Jan');
[ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );
